...
$pageTitle            = "Soru Bankası";
$pageDescription      = "Fizik sorularını güncelleyin, kategorilere ayırın.";
$yeniKayitButonMetni  = "Soru Ekle";
    ...
    <div class="admin-layout-wrapper">
        ...
        <div class="admin-main-content">
            ...
            <div class="admin-page-header">
                <div>
                    <h1><i class="fa-solid fa-list-check"></i> <?php echo htmlspecialchars($pageTitle); ?></h1>
